...
const HeroV3: React.FC = () => {
  ...
  return (
    <section
      className="relative w-full h-[86vh] mt-10 bg-cover bg-center transition-all duration-700"
      style={{ backgroundImage: `url(${bgImages[currentBg]})` }}
    >
      <div className="w-full max-w-[1200px] mx-auto h-full relative z-20 flex flex-col items-center justify-center text-white text-center md:pt-0 pt-16">
        <p
        ...
        <SearchBar />
        <p className="text-white font-medium mt-16 text-md md:mb-8 mb-10">
        ...
        <div className="flex justify-center gap-4 flex-wrap">
          {carTypes.map((type, idx) => (
            <div
              key={idx}
              className="flex items-center gap-2 bg-white/20 hover:bg-white/40 px-8 py-3 rounded-full text-white text-sm"
            >
