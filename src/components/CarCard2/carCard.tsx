...
const CarCard: React.FC<CarCardProps> = ({
  ...
  return (
    <motion.div
      className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-200 h-full transition-all duration-300"
      whileHover={{
        y: -5,
        ...
        >
          ...
          <motion.div whileHover={{ scale: 1.05, x: 2 }}>
            <Link
              ...
              className="text-red-600 text-sm font-medium flex items-center gap-1 hover:text-red-700 transition-colors"
            >
              View Details
