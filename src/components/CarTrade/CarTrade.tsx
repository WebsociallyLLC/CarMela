      ...
      <div className="container max-w-screen-xl mx-auto flex flex-col md:flex-row items-center md:justify-between md:gap-16">
        ...
        <div className="md:w-[40%] w-full space-y-6 mt-6 md:mt-0">
          ...
          <p className="text-[#fff] font-[400] text-[15px]">
            We are committed to providing our customers with exceptional <br />
            service, <br /> competitive pricing, and a wide range of.
          </p>
          <ul className="space-y-3 text-gray-300">
            {feature.map((featureText, index) => (
              <li key={index} className="flex items-center gap-2">
                <span className="text-white px-2 py-2 rounded-full bg-[#121212] text-xl">
                  <FaCheck size={14} />
                </span>
          ...
          <button className="inline-block bg-[#FF0000] hover:bg-[#FF0000] text-white font-medium px-6 py-3 rounded-[12px] transition duration-200 flex items-center gap-2">
            Get Started
            <span className="ml-2">
              <svg
